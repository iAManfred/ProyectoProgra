 ...
 setList(newList);
  ...
  return f;}
    ...
    public Beverage CrearBebida(String beverage){
        ...
        switch(beverage){
            case"House Blend":{  beverage1 =new HouseBlend();
                
                    break;}
            case"Dark Roast":{ beverage1 =new DarkRoast();
                
                    break;}
            case"Espresso":{ beverage1 =new Espresso();
                
                    break;}
            case"Decaf":{ beverage1 =new Decaf();
    ...
    public Beverage CrearDecorador(String nom, Beverage b){
        ...
        switch(nom){
            case"Milk":{   beverage1 =new Milk(b);
                
                      break;}
            case"Mocha":{    beverage1 =new Mocha(b);
                
                    break;}
            case"Soy":{    beverage1 =new Soy(b);
                
                    break;}
            case"Whip":{    beverage1=new Whip(b);
                
                break;
            }
             case"Candy":{   beverage1 =new Candy(b);
